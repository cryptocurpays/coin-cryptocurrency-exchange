...
class BitcoinCashRPC {
  ...
  async listTransactions(...params) {
    let req = await this.performMethod('listTransactions', ...params);
    ...
    /**
     * @return {Object} array of all unspent transactions
     */
  ...
  /**
    ...
    /**
     * @param  {String} Address   bitcoin address to send to
     * @param {String} (string, optional, default="") An optional label
     * @param resca     (boolean, optional, default=true) Rescan the wallet for transactions
    ...
    async setaccount(...params) {
        ...
        let req = await this.performMethod('setaccount', ...params);
        ...
        return axios(req)
            ...
            .catch(err => {
                console.log('failed in setaccount', err);
                return err.message;
            });
    }


    async importaddress(...params) {
        /*if (!this.isValidAddress(...params)) {
            console.log('failed valid check');
            return 'invalid address given';
        }*/

        let req = await this.performMethod('importaddress', ...params);
        ...
        return axios(req)
            ...
            .catch(err => {
                console.log('failed in importaddress', err);
                return err.message;
            });
    }
